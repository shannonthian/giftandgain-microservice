...
public class UserserviceApplication {
	...
	CommandLineRunner run(UserService userService) {
		return args -> {
			userService.saveRole(new Authorities(null, "ROLE_USER"));
			userService.saveRole(new Authorities(null, "ROLE_MANAGER"));
			userService.saveRole(new Authorities(null, "ROLE_ADMIN"));
			userService.saveRole(new Authorities(null, "ROLE_SUPER_ADMIN"));
