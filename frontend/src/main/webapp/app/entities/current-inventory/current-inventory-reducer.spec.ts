...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './current-inventory.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRENTINVENTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CURRENTINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CURRENTINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CURRENTINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CURRENTINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CURRENTINVENTORY actions', async () => {
      const expectedActions = [
        {
