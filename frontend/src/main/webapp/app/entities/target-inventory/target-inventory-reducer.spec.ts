...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TARGETINVENTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TARGETINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TARGETINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TARGETINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TARGETINVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TARGETINVENTORY actions', async () => {
      const expectedActions = [
        {
